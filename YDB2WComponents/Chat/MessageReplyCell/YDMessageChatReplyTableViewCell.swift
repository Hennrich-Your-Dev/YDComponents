//
//  YDMessageChatReplyTableViewCell.swift
//  YDB2WComponents
//
...
public class YDMessageChatReplyTableViewCell: UITableViewCell {
  // MARK: Enum
  ...
  public func config(
    ...
    replyMessageComponent.configure(with: chat)
  }
...
extension YDMessageChatReplyTableViewCell {
  ...
  func configureReplyMessageComponent() {
    ...
    NSLayoutConstraint.activate([
      ...
      replyMessageComponent.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 6),
      replyMessageComponent.heightAnchor.constraint(equalToConstant: 34)
    ])
  }
